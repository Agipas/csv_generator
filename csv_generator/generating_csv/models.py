...
class DataScheme(models.Model):
    ...
    column_separator = models.CharField(max_length=50, choices=SEPARATOR, blank=False, default=',')
    string_character = models.CharField(max_length=50, choices=QUALIFIER, blank=False, default='"')
